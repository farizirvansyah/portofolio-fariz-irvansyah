...
// $query = mysqli_query($conn, "SELECT * FROM skills ORDER BY id ASC");
...
<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
  <div>
    <h3 class="fw-bold mb-3">Management Skills</h3>
    <h6 class="op-7 mb-2">Free Bootstrap 5 Admin Dashboard</h6>
  </div>
  <div class="ms-md-auto py-2 py-md-0">
    <!-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a> -->
    <a href="app.php?page=create-skill" class="btn btn-primary btn-round">Create New Skill</a>
  </div>
</div>
<div class="row">
          ...
          <tbody>
            <?php foreach ($rows as $index => $row): ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-success btn-sm" href="app.php?page=create-skill&edit=<?php echo $row['id'] ?>">Edit</a>
