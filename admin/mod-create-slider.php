                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="mb-3">
                          <label for="button1_text" class="form-label fw-bold">Button 1 - Text</label>
                          <input type="text" name="button1_text" class="form-control" required
                            value="<?php echo isset($row['button1_text']) ? $row['button1_text'] : '' ?>">
                        </div>
                        <div class="mb-3">
                          <label for="button1_link" class="form-label fw-bold">Button 1 - Link</label>
                      ...
                      <div class="col-sm-6">
                        <div class="mb-3">
                          <label for="button2_text" class="form-label fw-bold">Button 2 - Text</label>
                          <input type="text" name="button2_text" class="form-control" required
                            value="<?php echo isset($row['button2_text']) ? $row['button2_text'] : '' ?>">
                        </div>
                        <div class="mb-3">
                          <label for="button2_link" class="form-label fw-bold">Button 2 - Link</label>
                      ...
                      <div class="col-lg-12">
                        <div class="mb-3">
                          ...
                          <?php if ($id && !empty($row['image'])): ?>
                            <small class="text-muted">Current file: <?php echo $row['image']; ?></small>
                          <?php endif; ?>
                        </div>
                        <div class="mb-3">
