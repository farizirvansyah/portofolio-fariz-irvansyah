...
<head>
  ...
  <title>Management Contacts</title>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-primary btn-sm"
                              href="contact-detail.php?edit=<?php echo $row['id'] ?>">Detail</a>
                            <a onclick="return confirm('Are you sure wanna delete this data?')"
                              class="btn btn-danger btn-sm" href="contact.php?delete=<?php echo $row['id'] ?>">Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
