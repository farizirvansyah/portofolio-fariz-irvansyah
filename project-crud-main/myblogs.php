...
if (isset($_GET['delete'])) {
  ...
  header("location:myblog.php?hapus=berhasil");
...
<body>
  <div class="wrapper">
        ...
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            ...
            <div class="ms-md-auto py-2 py-md-0">
              ...
              <a href="create-myblog.php" class="btn btn-primary btn-round">Create New My Blog</a>
            </div>
          </div>
          <div class="row">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a onclick="return confirm('Are you sure wanna delete this data?')"
                              class="btn btn-danger btn-sm" href="myblogs.php?delete=<?php echo $row['id'] ?>">Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
    ...
    <!-- Custom template | don't include it in your myblog! -->
  </div>
  <?php
  include "inc/js.php";
  ?>
